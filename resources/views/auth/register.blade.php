                    ...
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">Optional. A default image will be used if left blank.</small>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="form-text text-muted">You will need to verify this email before accessing the application.</small>
